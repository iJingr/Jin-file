...
<div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="记录时间" prop="jilushijian">
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="学生表现" prop="xueshengbiaoxian">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="学生表现"
