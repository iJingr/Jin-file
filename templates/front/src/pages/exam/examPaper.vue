...
<div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
    <div class="section-title" :style='{"margin":"10px 0","color":"#333","textAlign":"center","background":"#fff","fontSize":"22px","lineHeight":"54px","fontWeight":"600"}'>心理测评</div>
    <el-table
      :data="tableData"
      style="width: 100%">
      <el-table-column
      ...
      <el-table-column label="操作" width="150">
        <template slot-scope="scope">
          <el-button
            type="success"
            size="mini"
            @click="handleExam(scope.$index, scope.row)">心理测试</el-button>
        </template>
      </el-table-column>
    </el-table>
