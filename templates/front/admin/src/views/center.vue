  ...
  <div :style='{"padding":"30px","margin":"0"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='xinlizixunshi'"  label="咨询师账号" prop="zixunshizhanghao">
          <el-input v-model="ruleForm.zixunshizhanghao" readonly              placeholder="咨询师账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='xinlizixunshi'"  label="咨询师姓名" prop="zixunshixingming">
          <el-input v-model="ruleForm.zixunshixingming"               placeholder="咨询师姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='xinlizixunshi'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
            <el-option
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='xinlizixunshi'"  label="联系方式" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi"               placeholder="联系方式" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='xinlizixunshi'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='xinlizixunshi'"  label="个人简介" prop="gerenjianjie">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'xinlizixunshi' ==this.flag && this.ruleForm.lianxifangshi&&(!isMobile(this.ruleForm.lianxifangshi))){
