<template>
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="咨询评估" prop="zixunpinggu">
					<el-select :disabled="ro.zixunpinggu" v-model="ruleForm.zixunpinggu" placeholder="请选择咨询评估" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="咨询评估" prop="zixunpinggu">
					<el-input v-model="ruleForm.zixunpinggu"
						placeholder="咨询评估" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="评估内容" prop="pingguneirong">
					<el-input v-model="ruleForm.pingguneirong" placeholder="评估内容" clearable  :readonly="ro.pingguneirong"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="评估内容" prop="pingguneirong">
					<el-input v-model="ruleForm.pingguneirong" placeholder="评估内容" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="咨询师账号" prop="zixunshizhanghao">
					<el-input v-model="ruleForm.zixunshizhanghao" placeholder="咨询师账号" clearable  :readonly="ro.zixunshizhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="咨询师账号" prop="zixunshizhanghao">
					<el-input v-model="ruleForm.zixunshizhanghao" placeholder="咨询师账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="咨询师姓名" prop="zixunshixingming">
					<el-input v-model="ruleForm.zixunshixingming" placeholder="咨询师姓名" clearable  :readonly="ro.zixunshixingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="咨询师姓名" prop="zixunshixingming">
...
export default {
    ...
    info(id) {
      this.$http({
        url: `zixunxiaoguopinggu/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `zixunxiaoguopinggu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.zixunxiaoguopingguCrossAddOrUpdateFlag = false;
											this.parent.search();
