  ...
  <div class="main-content" :style='{"padding":"30px","margin":"0"}'>
      ...
      <el-form :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm" class="center-form-pv">
		<el-row :style='{"display":"block"}'>
			<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
			  ...
			  <el-input v-model="searchForm.name" placeholder="心理测评名称" clearable></el-input>
			</div>
	...
	<div :style='{"width":"100%","padding":"10px"}'>
        ...
        >
          ...
          <el-table-column :resizable='true' :sortable='true' prop="name" header-align="center" align="center" sortable label="心理测评">
          ...
          >
            <template slot-scope="scope">
			  <el-button class="view" :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 10px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#2ddcd3","width":"auto","fontSize":"14px","height":"32px"}' type="success" @click="addOrUpdateHandler(scope.row.id)">
