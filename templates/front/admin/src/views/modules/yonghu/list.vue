<template>
	<div class="main-content" :style='{"padding":"30px","margin":"0"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('yonghu','测评结果分析')" @click="cepingjieguofenxiCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
		...
		<cepingjieguofenxi-cross-add-or-update v-if="cepingjieguofenxiCrossAddOrUpdateFlag" :parent="this" ref="cepingjieguofenxiCrossaddOrUpdate"></cepingjieguofenxi-cross-add-or-update>
...
import cepingjieguofenxiCrossAddOrUpdate from "../cepingjieguofenxi/add-or-update";
	export default {
		data() {
			return {
				searchForm: {
				...
				cepingjieguofenxiCrossAddOrUpdateFlag: false,
		...
		components: {
			AddOrUpdate,
			cepingjieguofenxiCrossAddOrUpdate,
		},
		methods: {
			imgPreView(url){
				this.previewImg = url
			...
			cepingjieguofenxiCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.cepingjieguofenxiCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.cepingjieguofenxiCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.cepingjieguofenxiCrossaddOrUpdate.init(row.id,type);
				});
			},
