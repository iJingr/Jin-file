  ...
  <div class="main-content" :style='{"padding":"30px","margin":"0"}'>
    ...
    <template v-if="!showFlag">
      <el-form :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm" class="center-form-pv">
        <el-row :style='{"display":"block"}'>
			...
			<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
			  <label :style='{"margin":"0 10px 0 0","color":"#374254","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"600","height":"40px"}' class="item-label">测试试题</label>
        ...
        <el-row class="actions" :style='{"flexWrap":"wrap","margin":"20px 0","display":"flex"}'>
		  <el-button class="add" :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"4px","outline":"none","color":"#fff","borderRadius":"4px","background":"#ffa22b","width":"auto","fontSize":"14px","height":"40px"}' type="success" @click="addOrUpdateHandler()">
		  	<span class="icon iconfont icon-tianjia1" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
		  	添加
		  </el-button>
		  <el-button class="del" :disabled="dataListSelections.length <= 0" :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"4px","outline":"none","color":"#fff","borderRadius":"4px","background":"#ff382b","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}' type="danger" @click="deleteHandler()">
	...
	<div :style='{"width":"100%","padding":"10px"}'>
        ...
        >
          ...
          >
            <template slot-scope="scope">
			  <el-button class="edit" :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 10px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#4771db","width":"auto","fontSize":"14px","height":"32px"}' type="success" @click="addOrUpdateHandler(scope.row.id)">
			  	<span class="icon iconfont icon-bianji" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
			  	修改
			  </el-button>
			  <el-button class="del" :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 10px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#ff382b","width":"auto","fontSize":"14px","height":"32px"}' type="primary" @click="deleteHandler(scope.row.id)">
