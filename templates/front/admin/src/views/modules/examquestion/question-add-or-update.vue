<template>
  <div :style='{"padding":"30px","margin":"0"}'>
    <el-form
      ...
      label-width="180px"
    >
      <el-form-item :style='{"margin":"0 0 20px 0"}' label="选择心理测评" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择心理测评">
          <el-option
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择心理测评", trigger: "blur" }],
        questionname: [
