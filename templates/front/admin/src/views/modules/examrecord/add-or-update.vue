<template>
  <div class="main-content" :style='{"padding":"30px","margin":"0"}'>
    <!-- 列表页 -->
    <div v-if="!showFlag">
      <el-form :style='{"border":"1px solid rgba(167, 180, 201,.3)  ","padding":"30px","borderRadius":"6px","background":"#fff"}' :inline="true" :model="searchForm" class="add-update-preview">
        <el-form-item :style='{"margin":"0 0 20px 0"}' label="心理测评">
