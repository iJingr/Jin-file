	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="个人简介" prop="gerenjianjie">
					<el-input v-model="ruleForm.gerenjianjie" placeholder="个人简介" clearable  :readonly="ro.gerenjianjie"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="个人简介" prop="gerenjianjie">
					<el-input v-model="ruleForm.gerenjianjie" placeholder="个人简介" readonly></el-input>
				</el-form-item>
			</template>
